...
This bundled reference is the runtime normalization contract for the Codex HAIL skill set. Repository-level semantic authority remains `spec/semantics.md`; this file exists so installed skills do not depend on repository-only documentation.
...
6. generate the Codex projection only from the validated normalized/current profile.
