...
This skill is an independently discoverable read-only surface over HAIL's persistent profile-management behavior. The canonical profile remains the source of truth.
