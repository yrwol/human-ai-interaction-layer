...
This bundled reference defines the current runtime profile shape and allowed values for the Claude HAIL plugin. Repository-level semantic authority remains `spec/semantics.md`.
